...
func (c *playerServiceClient) GetAllPlayers(ctx context.Context, in *GetAllPlayersRequest, opts ...grpc.CallOption) (*PlayerListResponse, error) {
...
func _PlayerService_GetAllPlayers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PlayerServiceServer).GetAllPlayers(ctx, req.(*GetAllPlayersRequest))
	}
